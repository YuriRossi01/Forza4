...
int main (int argc, char *argv[]) {
    ...
    // Lettura gettoni
    if(gettone1 != G1 && gettone1 != G2 && gettone2 != G1 && gettone2 != G2){
        printf("<Server> Devi mettere i gettoni O o X\n");
        exit(1);
    }
    if(gettone2 == gettone1){
        printf("<Server> I gettoni non possono essere gli stessi\n");
        exit(1);
    }
